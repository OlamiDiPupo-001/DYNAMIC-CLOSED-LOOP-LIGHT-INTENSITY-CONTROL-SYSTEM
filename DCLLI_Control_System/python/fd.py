...
def main():
    ...
    with open("F:/DOCUMENT/ROBOTICS/5th Semester/microprocessor/L08_Example/L08_Example_4-5/Components/Src/sine_wave_buffer.c", "w") as src:
        src.write("// PYTHON GENERATED FILE\n")
        src.write(str(cw_src))

    with open("F:/DOCUMENT/ROBOTICS/5th Semester/microprocessor/L08_Example/L08_Example_4-5/Components/Inc/sine_wave_buffer.h", "w") as inc:
